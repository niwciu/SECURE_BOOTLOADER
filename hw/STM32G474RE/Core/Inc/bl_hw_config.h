 ...
 * @brief Hardware configuration for STM32G474RE bootloader target.
 * @version 1.0.0
 * @date 2026-05-05
 *
...
#define APP_END                  0x08080000UL   /* 512 KB application region   */
...
#define SRAM_END                 (SRAM_START + (128U * 1024U))
